...
async def start(_, message: Message):
         ...
         reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "🔊 Asistan", url="https://t.me/LuciMusicAsistant"
                    ),
                    InlineKeyboardButton(
                        "💬 Sohbet", url="https://t.me/LuciDestek"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "Resmi Kanal 🇹🇷", url=f"https://t.me/Luci_SUP"
                    )
                ]
